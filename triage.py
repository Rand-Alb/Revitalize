...
class TriageGUI:
    ...
    def __init__(self, root):
        ...
        tk.Label(root, text="Patient Name").grid(row=0, column=0, sticky="e", padx=10, pady=5)
        self.name_entry = tk.Entry(root)
        self.name_entry.grid(row=0, column=1, sticky="ew", padx=10, pady=5)

        tk.Label(root, text="Condition").grid(row=1, column=0, sticky="e", padx=10, pady=5)
        ...
        menu.grid(row=1, column=1, sticky="ew", padx=10, pady=5)
        tk.Button(root, text="Add Patient", command=self.add_patient).grid(row=2, column=0, columnspan=2, sticky="ew", padx=10, pady=5)

        self.output = tk.Text(root, height=15)
        self.output.grid(row=3, column=0, columnspan=2, sticky="nsew", padx=10, pady=5)

        tk.Button(root, text="Call Next Patient", command=self.call_next).grid(row=4, column=0, columnspan=2, sticky="ew", padx=10, pady=(5, 10))
